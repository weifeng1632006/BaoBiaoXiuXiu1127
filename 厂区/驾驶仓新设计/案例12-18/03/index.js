        ...
        `   
            <div class="grid-content ep-bg-purple div-card-col-1">
                    <el-card class="card-data-col-1">
                        <sapn class="mx-1 card-product-name">电解铜数据（吨）:</sapn>
                        <el-row>
                            <el-col :span="6">
                                <p class="product-data-1"><span>{{formatNumber(pnumber_d,3)}} </span></p>
                                <p class="product-data-2"><span >日产量</span></p>
                                <p class="product-data-3"><span >预算完成率:<span>{{formatNumber(wanchen_d,2,100)}}%</span></span></p>

                            </el-col>
                            <el-col :span="6">
                                <p class="product-data-1"><span>{{formatNumber(pnumber_m,3)}} </span></p>
                                <p class="product-data-2"><span >月产量</span></p>
                                <p class="product-data-3"><span >预算完成率:<span>{{formatNumber(wanchen_m,2,100)}}%</span></span></p>

                            </el-col>
                             <el-col :span="6">
                                <p class="product-data-1"><span>{{formatNumber(pnumber_y,3)}} </span></p>
                                <p class="product-data-2"><span >年产量</span></p>
                                <p class="product-data-3"><span >预算完成率:<span>{{formatNumber(wanchen_y,2,100)}}%</span></span></p>
    ...
    template:
        `   
         <div class="data-chenben">
                <el-row>
                    <el-col :span="12">
                        <p class="mx-1 p-chenben-1"><span>{{titlename_1}}</span></p>
                        <p class="mx-1  p-chenben-2"><span>{{formatNumber(cbdata_1,2)}}</span></p>
                    </el-col>
                    <el-col :span="12">
                       <p class="mx-1 p-chenben-1"><span>{{titlename_2}}</span></p>
                        <p class="mx-1  p-chenben-2"><span>{{formatNumber(cbdata_2,2)}}</span></p>
                </el-row>
        </div>        
