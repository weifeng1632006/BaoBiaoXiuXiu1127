    ...
    template: ` 
      <div style="margin-bottom: 25px; text-align: center;">
            <el-row>
                ...
                <el-col :span="12">
                    <div v-if="!baifen" style="color: #1f0ce7ff; font-size: 18px; font-weight: bold;">{{ formatNumber(cbdata_2, intround) }}</div>
        ...
        const initAnimation = () => {
            ...
            class Snowflake {
                ...
                reset() {
                    ...
                    this.size = Math.random() * 1 + 2; this.vy = Math.random() * 1 + 0.5;
                ...
                draw() {
                    ...
                    ctx.beginPath(); ctx.arc(this.x, this.y, this.size, 0, Math.PI * 4); ctx.fill();
                }
            }
