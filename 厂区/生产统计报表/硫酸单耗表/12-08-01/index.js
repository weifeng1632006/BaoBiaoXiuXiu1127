...
createApp(

    {
        ...
        setup() {
            ...
            fetchData(tableData, "factdata/scbb/liusuandanhao")
                ...
                columns.forEach((column, index) => {
                    ...
                    if (!values.every(value => isNaN(value))) {
                        ...
                        if (['萃取电积1',
                            ...
                            sums[index] = (sum).toLocaleString('en-US', { maximumFractionDigits: 2 });
                        }


                        else if (column.property === '浸出硫酸单耗KG/T矿') {

                            divpercent("浸出硫酸消耗", "合计干吨", 1000)

                        }
                        else if (column.property === '浸出硫酸单耗吨/T铜') {

                            divpercent("浸出硫酸消耗", "一到五期电解")

                        }
                        else if (column.property === '合计硫酸单耗吨/T铜') {

                            divpercent("每日消耗汇总", "一到五期电解")

                        }
                        else if (column.property === '合计硫酸单耗KG') {

                            divpercent("每日消耗汇总", "合计干吨", 1000)
