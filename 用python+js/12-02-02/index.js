...
createApp({
    setup() {
        ...
        const tableRowClassName = ({ rowIndex }) => {
            ...
            if (rowIndex === dataLength.value-1) {
                console.log(`filteredData的长度`, dataLength.value)
       ...
       const  cellStyleMethod=({ row, column, rowIndex, columnIndex })=>{

            // console.log(`output->row`,row)
            // console.log(`output->column`,column)
            // console.log(`output->rowIndex`,rowIndex)
            // console.log(`output->columnIndex`,columnIndex)

            if (rowIndex ===  31) { // 第几列，从 0 开始
                return { color:"red" };
            }
