...
from base.config import WEBDATA_FORM_URL, WEBDATA_FORM_HEADERS, sourcedata_dir
from WebPostDict import list_web_post
import requests
...
class  WebDataBase(BaseClass):
    def __init__(self,dict_name,tofiledir="./"):
        ...
        self.table_name="秀秀数据_"+self.name
    ...
    def out_file(self,):
        ...
        try:
            ...
            filedir1=sourcedata_dir+self.tofiledir
            filedir=os.path.join(filedir1, self.table_name + ".csv")
            print(filedir)
            df.to_csv(filedir)
